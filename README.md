...
```
git clone https://github.com/isaacdarcilla/resume
```
...
A nice bootstrap alternative that doesn't have as much opinionative that is all the rage these days with the 'hates css' crowd that while not a part of, I definitely didn't want to fall behind and thus I took this opportunity to practice a bit. 
